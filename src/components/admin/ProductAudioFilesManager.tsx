 ...
 const ProductAudioFilesManager = ({ 
   productId, 
   isNewProduct = false,
   onFilesChange,
   pendingFiles = []
 }: ProductAudioFilesManagerProps) => {
   ...
   return (
     <div className="space-y-3">
       <div className="flex items-center justify-between">
         <label className="text-sm font-medium">Audio Files (MP3, WAV, etc.)</label>
       ...
       <p className="text-xs text-muted-foreground">
         Each audio file will be sent as a separate download link to the customer.
       </p>
     </div>
   );
 };
 
 export default ProductAudioFilesManager;